 ...
 * @since 3.4
 */
public class SnipMatchJavaTemplatesPage extends AbstractTemplatesPage {
    ...
    private ITextEditor fJavaEditor;
	...
	public SnipMatchJavaTemplatesPage(ITextEditor javaEditor, ISourceViewer viewer) {
		super(javaEditor, viewer);
	...
	/*
	 * @see
	 * org.eclipse.ui.texteditor.templates.AbstractTemplatesPage#insertTemplate
...
//			return;
		...
		ISourceViewer contextViewer = viewer;
		...
		proposal.apply(viewer, ' ', 0, region.getOffset());
		endCompoundChange(contextViewer);
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.ui.texteditor.templates.AbstractTemplatesPage#
	 ...
	 * 
	 * @see
	 * org.eclipse.ui.texteditor.templates.AbstractTemplatesPage#getTemplateStore
	 * ()
	 */
	@Override
	...
	/*
	 * @see
	 * org.eclipse.ui.texteditor.templates.TextEditorTemplatesPage#isValidTemplate
	 * (org.eclipse.jface.text.templates.Template, int, int)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.ui.texteditor.templates.TextEditorTemplatesPage#
	 * createPatternViewer(org.eclipse.swt.widgets.Composite)
	 */
	@Override
	protected SourceViewer createPatternViewer(Composite parent) {
		...
		SimpleJavaSourceViewerConfiguration configuration = new SimpleJavaSourceViewerConfiguration(tools.getColorManager(), store, null,
	 ...
	 * 
	 * @see
	 * org.eclipse.ui.texteditor.templates.AbstractTemplatesPage#getImageForTemplate
	 * (org.eclipse.jface.text.templates.Template)
	 */
	@Override
	...
	/*
	 * @see
	 * org.eclipse.ui.texteditor.templates.TextEditorTemplatesPage#editTemplate
	 * (org.eclipse.jface.text.templates.Template, boolean, boolean)
	 */
	@Override
	...
	/*
	 * @see org.eclipse.ui.texteditor.templates.TextEditorTemplatesPage#
	 * updatePatternViewer(org.eclipse.jface.text.templates.Template)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.eclipse.ui.texteditor.templates.AbstractTemplatesPage#getPreferencePageId
	 * ()
	 */
	@Override
	...
	/**
	 * Check whether the template is allowed eventhough the context can't
	 * evaluate it. This is needed because the Dropping of a template is more
	 * lenient than ctl-space invoked code assist.
	 * 
	 * @param context
	...
	private DocumentTemplateContext getContext(IDocument document, Template template, final int offset, int length) {
		...
		if (template.getContextTypeId().equals(JavaDocContextType.ID)) {
			context = new JavaDocContext(getContextTypeRegistry().getContextType(template.getContextTypeId()), document, new Position(offset, length),
					(ICompilationUnit) EditorUtility.getEditorInputJavaElement(fJavaEditor, true));
		} else {
			context = new JavaContext(getContextTypeRegistry().getContextType(template.getContextTypeId()), document, new Position(offset, length),
					(ICompilationUnit) EditorUtility.getEditorInputJavaElement(fJavaEditor, true));
		}
		return context;
	}
	...
	protected String[] getContextTypeIds(IDocument document, int offset) {
		try {
			...
			String[] ids = new String[] { JavaContextType.ID_ALL, JavaContextType.ID_MEMBERS, JavaContextType.ID_STATEMENTS, SWTContextType.ID_ALL,
					SWTContextType.ID_STATEMENTS, SWTContextType.ID_MEMBERS };
